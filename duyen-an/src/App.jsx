...
function BusinessOfTheWeek() {
  return (
    <section className="relative min-h-screen px-6 py-32 bg-gradient-to-b from-black via-red-950/30 to-black text-center overflow-hidden">
      ...
      <LuxuryPanel className="mx-auto mt-20 max-w-3xl p-12 spotlight-card">
        <motion.div
        ...
        <div className="spotlight-links mt-8">
          <a href="/business-directory.html">Click for Business Directory</a>
        </div>
      </LuxuryPanel>
    </section>
  );
    ...
    <section id="future-wing" className="relative min-h-screen overflow-hidden px-6 py-32 bg-gradient-to-b from-zinc-900 via-black to-black">
      <div className="mx-auto grid max-w-7xl items-center gap-16 md:grid-cols-2">
        ...
        <div>
          ...
          <button
            className="mt-12 rounded-full border border-white/10 bg-white/[0.03] px-8 py-4 uppercase tracking-[0.35em] text-white/65"
          >
            View the Future Wing
          </button>
        </div>
      </div>
    </section>
  ...
  return (
    <section id="visit" className="px-6 py-32 text-center bg-black">
      <SmartImage
        ...
        alt=""
        className="mx-auto mb-12 h-[420px] w-full max-w-5xl rounded-[2.5rem] object-cover opacity-75"
      />
      <p className="mb-6 text-xs uppercase tracking-[0.45em] text-amber-200/70">
        Contact
      </p>
